...
class ShapesArea
{
	...
	public static void Shapes(float l,float b)
	{
		...
		System.out.println("the area of triangle is "+rectangle);
	}

	public static void Shapes(double r)
	{
		double circle=3.14*r*r;
		System.out.println("the area of triangle is "+circle);
	}
}
